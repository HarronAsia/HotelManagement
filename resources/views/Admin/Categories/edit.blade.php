...
<div class="container register-form top-buffer-1">
    <div class="form">
        ...
        <div class="form-content bk">
            <form action="{{route('admin.categories.update',$category->title)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control " id="title" placeholder="Enter Title for Category" name="title" value="{{$category->title}}" required>
                            </div>
                        </div>
                    </div>
                    <!-- Category Information -->
