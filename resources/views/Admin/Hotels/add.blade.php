            ...
            <form action="{{route('admin.hotels.store',app()->getLocale())}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <img id="image_preview_container" src="{{asset('storage/default.png')}}" class="form-control" alt="preview Avatar Image">
                            </div>
                        </div>
                    </div>
                </fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control " id="hotel_name" placeholder="Enter Name of the Hotel" name="hotel_name" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group has-feedback{{ $errors->has('hotel_description') ? ' has-error' : '' }}">
                                ...
                                <textarea name="hotel_description" id="hotel_description" class="form-control" cols="140" rows="20" required></textarea>
                            </div>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group has-feedback{{ $errors->has('hotel_description') ? ' has-error' : '' }}">
                                <label for="hotel_description">Address:</label>
                                <input type="text" name="hotel_address" class="form-control" placeholder="Enter Address" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
